...
Questo esempio fornisce un processo passo passo per visualizzare un&#39;applicazione creata da Adobe Campaign in Facebook. In questo caso, desideriamo creare un&#39;applicazione che consenta di visualizzare il messaggio di **benvenuto** quando l&#39;utente fa clic sulla scheda dell&#39;applicazione (**App01**).
...
1. Crea un&#39;applicazione Web di tipo Facebook in Adobe Campaign. Per ulteriori informazioni, consulta: [Creazione di un’applicazione](../../social/using/creating-a-facebook-application.md#creating-a-facebook-type-web-application)Web di tipo Facebook.

   ![](assets/social_webapp_005.png)

1. Modificate l’applicazione Web. In questo esempio, abbiamo aggiunto un&#39; **[!UICONTROL Page]** attività e definito un titolo.
...
Tra i dati anonimi inoltrati ad Adobe Campaign da Facebook, viene raccolto il valore del **[!UICONTROL Application parameters]** campo, consentendo ad Adobe Campaign di personalizzare la visualizzazione dell&#39;applicazione in base a questo parametro.
...
* un&#39; **[!UICONTROL Test]** attività
* tre pagine
* un&#39; **[!UICONTROL Access control]** attività
* un&#39; **[!UICONTROL Pre-loading]** attività
* un&#39; **[!UICONTROL Save]** attività
...
* **[!UICONTROL Gender]**: genere utente
...
1. Nel **[!UICONTROL Reconciliation mode]** campo selezionare la modalità di riconciliazione da utilizzare:
   ...
   * **[!UICONTROL None]** : Non ci sarà riconciliazione.

1. Nel **[!UICONTROL Mapping]** campo selezionare lo schema su cui si desidera eseguire la riconciliazione.

   >[!CAUTION]
   >
   >Verificate che i campi della **[!UICONTROL Social networks]** scheda siano immessi correttamente nella mappatura della consegna. Le mappature di consegna sono accessibili tramite il **[!UICONTROL Administration > Campaign management > Target mappings]** nodo.
...
>[!NOTE]
>
>Prima di iniziare a utilizzare questa funzione, è necessario creare un&#39;applicazione Facebook e un account esterno di **[!UICONTROL Facebook Connect]** tipo. Per ulteriori informazioni, vedere [Configurazione di account](../../social/using/creating-a-facebook-application.md#configuring-external-accounts)esterni.
