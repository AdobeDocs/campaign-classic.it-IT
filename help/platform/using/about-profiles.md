...
* [Gestisci profili](https://experienceleague.adobe.com/it/docs/campaign/campaign-v8/config/configuration/folders-and-views?lang=en#_blank){target=_blank}: accedi e gestisci i profili esistenti utilizzando lo strumento di gestione delle cartelle.
