...
>[!NOTE]
>
>È possibile importare i dati senza mapparli con i dati del database utilizzando la funzione **[!UICONTROL Import a list]**.
>
>I dati possono quindi essere utilizzati esclusivamente in flussi di lavoro tramite l&#39;oggetto **[!UICONTROL Read list]**. Per ulteriori informazioni, consulta [questa pagina](../../workflow/using/read-list.md).
...
## Importazione guidata {#import-wizard}
...
## Campioni di importazione generici {#generic-import-samples}
...
### Esempio: Arricchite i valori con quelli di un file esterno {#example--enrich-the-values-with-those-of-an-external-file}
