...
Ulteriori informazioni su [Registri di tracciamento in Campaign v8](https://experienceleague.adobe.com/en/docs/campaign/campaign-v8/send/tracking-logs){target="_blank"} o [tracciamento specifico per v7](../../delivery/using/about-message-tracking.md).
+++
