...
+ Creare e inviare messaggi {#sending-messages}
   ...
   + Best practice per la consegna {#delivery-bestpractices}
      + [Ottimizzare la consegna - NASCOSTO](delivery/using/optimize-delivery.md)
      + [Utilizzare modelli - NASCOSTO](delivery/using/use-templates.md)
      + [Creare contenuti personalizzati - NASCOSTO](delivery/using/design-and-personalize.md)
      + [Definire il pubblico adatto - NASCOSTO](delivery/using/define-the-right-audience.md)
      + [Controllare prima dell’invio - NASCOSTO](delivery/using/check-before-sending.md)
   ...
   + Inviare e-mail {#sending-emails}
      ...
      + Inviare la consegna e-mail {#sending-an-email}
         + [Passaggi principali per inviare un’e-mail - NASCOSTO](delivery/using/sending-messages.md)
         + [Parametri e-mail - NASCOSTO](delivery/using/email-parameters.md)
         + [Inviare su dispositivi mobili giapponesi - NASCOSTO](delivery/using/sending-emails-on-japanese-mobiles.md)
      + [Allegare file - NASCOSTO](delivery/using/attaching-files.md)
   ...
   + Inviare notifiche push {#sending-push-notifications}
      ...
      + Configurare l’app mobile{#configure-the-mobile-app}
         ...
         + [Passaggi di configurazione per iOS - NASCOSTO](delivery/using/configuring-the-mobile-application.md)
         + [Passaggi di configurazione per Android - NASCOSTO](delivery/using/configuring-the-mobile-application-android.md)
      + Creare una notifica push{#create-a-push-msg}
         + [Creare un messaggio push per iOS - NASCOSTO](delivery/using/create-notifications-ios.md)
         + [Creare un messaggio push per Android - NASCOSTO](delivery/using/create-notifications-android.md)
   ...
   + Inviare direct mail {#sending-direct-mail}
      + [Creare una consegna direct mail - NASCOSTO](delivery/using/creating-a-direct-mail-delivery.md)
      + [Definire il contenuto direct mail - NASCOSTO](delivery/using/defining-the-direct-mail-content.md)
      + [Convalidare - NASCOSTO](delivery/using/validating.md)
   + Utilizzare i modelli di consegna {#using-delivery-templates}
      ...
      + [Selezionare una mappatura target - NASCOSTO](delivery/using/selecting-a-target-mapping.md)
   ...
   + Personalizzare le consegne {#personalizing-deliveries}
      ...
      + [Campi di personalizzazione - NASCOSTO](delivery/using/personalization-fields.md)
      + [Blocchi di personalizzazione - NASCOSTO](delivery/using/personalization-blocks.md)
      + [Contenuto condizionale - NASCOSTO](delivery/using/conditional-content.md)
      + [Coupon personalizzati - NASCOSTO](delivery/using/personalized-coupons.md)
   ...
   + Monitorare le consegne {#monitoring-deliveries}
      ...
      + [Monitorare le consegne nell’interfaccia utente di Campaign](delivery/using/delivery-dashboard.md)
      ...
      + [Tracciamento dei messaggi](delivery/using/about-message-tracking.md)
...
+ Orchestrare campagne di marketing {#orchestrating-campaigns}
   ...
   + Informazioni sulle campagne di marketing {#about-marketing-campaigns}
      ...
      + [Accedere alle campagne di marketing - NASCOSTO](campaign/using/accessing-marketing-campaigns.md)
   + Orchestrare le campagne {#orchestrate-campaigns}
      ...
      + [Creare e configurare modelli - NASCOSTO](campaign/using/marketing-campaign-templates.md)
      + [Aggiungere consegne - NASCOSTO](campaign/using/marketing-campaign-deliveries.md)
   ...
   + Ottimizzazione delle campagne {#campaign-optimization}
      ...
      + [Applicare regole - NASCOSTO](campaign-opt/using/applying-rules.md)
      + [Simulazioni delle campagne - NASCOSTO](campaign-opt/using/campaign-simulations.md)
+ Gestione delle risorse marketing {#mrm}
   + [Informazioni sulla gestione delle risorse marketing - NASCOSTO](mrm/using/about-marketing-resource-management.md)
...
+ Marketing distribuito {#distributed-marketing}
   ...
   + [Pubblicare il pacchetto campagna - NASCOSTO](distributed/using/publishing-the-campaign-package.md)
   ...
   + [Casi d’uso - NASCOSTO](distributed/using/examples.md)
...
+ Automatizzare con i flussi di lavoro {#automating-with-workflows}
   + Introduzione ai flussi di lavoro {#introduction}
      ...
      + [Targeting dei dati - NASCOSTO](workflow/using/targeting-data.md)
      + [Utilizzare i dati del flusso di lavoro - NASCOSTO](workflow/using/how-to-use-workflow-data.md)
      + [Best practice per flusso di lavoro - NASCOSTO](workflow/using/workflow-best-practices.md)
   + Eseguire un flusso di lavoro {#executing-a-workflow}
      ...
      + [Ciclo di vita di un flusso di lavoro - NASCOSTO](workflow/using/workflow-life-cycle.md)
      ...
      + [Architettura - NASCOSTO](workflow/using/architecture.md)
   + Attività di targeting {#targeting-activities}
      ...
      + [Query incrementale - NASCOSTO](workflow/using/incremental-query.md)
      + [Leggi elenco - NASCOSTO](workflow/using/read-list.md)
      + [Unione - NASCOSTO](workflow/using/union.md)
      + [Intersezione - NASCOSTO](workflow/using/intersection.md)
      + [Esclusione - NASCOSTO](workflow/using/exclusion.md)
      + [Suddivisione - NASCOSTO](workflow/using/split.md)
      + [Celle - NASCOSTO](workflow/using/cells.md)
      + [Offerte per cella - NASCOSTO](workflow/using/offers-by-cell.md)
      + [Struttura della consegna - NASCOSTO](workflow/using/delivery-outline.md)
      + [Arricchimento - NASCOSTO](workflow/using/enrichment.md)
      + [Modificare schema - NASCOSTO](workflow/using/edit-schema.md)
      + [Motore di offerta - NASCOSTO](workflow/using/offer-engine.md)
      + [Deduplica - NASCOSTO](workflow/using/deduplication.md)
      + [Cambia dimensione - NASCOSTO](workflow/using/change-dimension.md)
      + [Aggiornamento elenco - NASCOSTO](workflow/using/list-update.md)
      + [Servizi di abbonamento - NASCOSTO](workflow/using/subscription-services.md)
      + [Aggiornare dati - NASCOSTO](workflow/using/update-data.md)
      + [Connettore CRM - NASCOSTO](workflow/using/crm-connector.md)
      + [Cambiare origine dati - NASCOSTO](workflow/using/change-data-source.md)
   + Attività di controllo del flusso {#flow-control-activities}
      ...
      + [Modulo di pianificazione - NASCOSTO](workflow/using/scheduler.md)
      + [Test - NASCOSTO](workflow/using/test.md)
      + [Attendere - HIDDEN](workflow/using/wait.md)
      ...
      + [Attività - NASCOSTO](workflow/using/task.md)
   + Attività di azione {#action-activities}
      ...
      + [Consegna - NASCOSTO](workflow/using/delivery.md)
      ...
      + [Consegne cross-channel - NASCOSTO](workflow/using/cross-channel-deliveries.md)
      ...
      + [Aggiorna aggregato - NASCOSTO](workflow/using/update-aggregate.md)
   + Attività di eventi {#event-activities}
      + [Informazioni sulle attività di eventi - NASCOSTO](workflow/using/about-event-activities.md)
      + [Raccolta file - NASCOSTO](workflow/using/file-collector.md)
   ...
   + Casi d’uso {#use-cases}
      + [Informazioni sui casi d’uso dei flussi di lavoro - NASCOSTO](workflow/using/about-workflow-use-cases.md)
      + Consegne {#deliveries}
         ...
         + [Caricare i contenuti della consegna - NASCOSTO](workflow/using/loading-delivery-content.md)
         + [Flusso di lavoro per consegna cross-channel - NASCOSTO](workflow/using/cross-channel-delivery-workflow.md)
   ...
   + Monitoraggio {#monitoring}
      ...
      + [Controllare i flussi di lavoro - NASCOSTO](workflow/using/supervising-workflows.md)
      + [Inviare avvisi personalizzati agli operatori - NASCOSTO](workflow/using/sending-personalized-alerts-to-operators.md)
   + Gestione dati {#data-management}
      + [Coordinare gli aggiornamenti dei dati - NASCOSTO](workflow/using/coordinating-data-updates.md)
      + [Creare un elenco di riepilogo - NASCOSTO](workflow/using/creating-a-summary-list.md)
      + [Arricchire i dati - NASCOSTO](workflow/using/enriching-data.md)
      + [Utilizzare aggregati - NASCOSTO](workflow/using/using-aggregates.md)
      + [Utilizzare la funzionalità di unione dell’attività Deduplica - NASCOSTO](workflow/using/deduplication-merge.md)
   ...
   + Progettare le query {#designing-queries}
      + [Aggiornamento dell’elenco trimestrale tramite una query incrementale - NASCOSTO](workflow/using/quarterly-list-update.md)
   + Query e filtro {#query-and-filter-hidden}
      ...
      + [Eseguire il calcolo degli aggregati - NASCOSTO](workflow/using/performing-aggregate-computing.md)
      + [Eseguire una query tramite gestione dei raggruppamenti - NASCOSTO](workflow/using/querying-using-grouping-management.md)
      ...
      + [Aggiungere un campo calcolato di tipo enumerazione - NASCOSTO](workflow/using/adding-enumeration-type-calculated-field.md)
   ...
   + Monitorare i flussi di lavoro {#monitoring-workflows}
      ...
      + [Monitorare i flussi di lavoro tecnici - NASCOSTO](workflow/using/monitoring-technical-workflows.md)
      + [HeatMap flusso di lavoro - NASCOSTO](workflow/using/heatmap.md)
   + Gestione avanzata {#advanced-management}
      + [Proprietà del flusso di lavoro - NASCOSTO](workflow/using/workflow-properties.md)
      + [Parametri avanzati - NASCOSTO](workflow/using/advanced-parameters.md)
      + [Script e modelli JavaScript - NASCOSTO](workflow/using/javascript-scripts-and-templates.md)
      ...
      + [Gestire le autorizzazioni - NASCOSTO](workflow/using/managing-rights.md)
      + [Modificare le immagini dell’attività - NASCOSTO](workflow/using/managing-activity-images.md)
