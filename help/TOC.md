---
audience: end-user
user-guide-title: Guida Adobe Campaign Classic
...
+ Guida introduttiva {#getting-started}
   ...
   + Accesso a un database esterno (FDA){#accessing-external-database}
      ...
      + [Definizione della mappatura dei dati](platform/using/defining-data-mapping.md)
...
+ Invio di messaggi {#sending-messages}
   ...
   + Invio di notifiche push {#sending-push-notifications}
      ...
      + [Configurazione dell’app mobile in Adobe Campaign](delivery/using/configuring-the-mobile-application.md)
...
+ Integrazione con Adobe Experience Cloud {#integrating-with-adobe-experience-cloud}
   ...
   + Trigger di Experience Cloud {#experience-triggers}
      ...
      + [Eventi di trigger](integrations/using/events.md)
...
+ Installazione di Campaign Classic {#installing-campaign-classic}
   ...
   + Appendici {#appendices}
      ...
      + [Elenco opzioni di Campaign Classic](installation/using/configuring-campaign-options.md)
...
+ Migrazione a una nuova versione {#migrating-to-a-new-version}
   ...
   + Ripristino di una versione precedente {#rollback}
      + [Informazioni sul ripristino di una versione precedente](migration/using/about-rollback.md)
      + [Ripristino della versione v5.11](migration/using/restoring-v5-11.md)
      + [Ripristino della versione v6.02](migration/using/restoring-v6-02.md)
      + [Ripristino della versione v6.1](migration/using/restoring-v6-1.md)
