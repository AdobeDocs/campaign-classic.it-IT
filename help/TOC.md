...
+ Introduzione {#getting-started}
  ...
  + {hide-from-toc}[Utilizzare Campaign Explorer - NASCOSTO](platform/using/adobe-campaign-explorer.md)
  + {hide-from-toc}[Sfogliare e personalizzare gli elenchi - NASCOSTO](platform/using/adobe-campaign-ui-lists.md)
  ...
  + Gestione dei profili {#profile-management}
    ...
    + {hide-from-toc}[Modificare un profilo - NASCOSTO](platform/using/editing-a-profile.md)
    + {hide-from-toc}[Aggiungere profili - NASCOSTO](platform/using/adding-profiles.md)
    + {hide-from-toc}[Gestire i profili - NASCOSTO](platform/using/managing-profiles.md)
    + [Aggiornare i dati](platform/using/updating-data.md)
    + {hide-from-toc}[Importare ed esportare i profili - NASCOSTO](platform/using/exporting-and-importing-profiles.md)
  ...
  + Filtrare i dati {#filtering-data}
    ...
    + {hide-from-toc}[Creare filtri - NASCOSTO](platform/using/creating-filters.md)
    + {hide-from-toc}[Caso d’uso - nascosto](platform/using/use-case.md)
  + {hide-from-toc}[Passaggi per creare una query - NASCOSTO](platform/using/steps-to-create-a-query.md)
  + {hide-from-toc}[Definire le condizioni del filtro - NASCOSTO](platform/using/defining-filter-conditions.md)
  + Autorizzazioni {#permissions}
    ...
    + {hide-from-toc}[Gestire l’accesso alle cartelle - NASCOSTO](platform/using/access-management-folders.md)
  + Connettori CRM {#connectors}
    ...
    + {hide-from-toc}[Connessione con Salesforce.com](platform/using/crm-sfdc.md)
    + {hide-from-toc}[Sincronizzare i dati con il CRM](platform/using/crm-data-sync.md)
  + {hide-from-toc}[Opzioni di assistenza e supporto - NASCOSTE](support.md)
+ Creare e inviare messaggi {#sending-messages}
  ...
  + Avvio rapido {#key-steps-when-creating-a-delivery}
    ...
    + {hide-from-toc}[Creare e identificare una consegna - NASCOSTO](delivery/using/steps-create-and-identify-the-delivery.md)
    + {hide-from-toc}[Definire il pubblico - NASCOSTO](delivery/using/steps-defining-the-target-population.md)
    + {hide-from-toc}[Convalidare la consegna - NASCOSTO](delivery/using/steps-validating-the-delivery.md)
    + {hide-from-toc}[Inviare la consegna - NASCOSTO](delivery/using/steps-sending-the-delivery.md)
  ...
  + Best practice per la consegna {#delivery-bestpractices}
    + {hide-from-toc}[Ottimizzare la consegna - NASCOSTO](delivery/using/optimize-delivery.md)
    + {hide-from-toc}[Utilizzare i modelli - NASCOSTO](delivery/using/use-templates.md)
    + {hide-from-toc}[Creare contenuti personalizzati - NASCOSTO](delivery/using/design-and-personalize.md)
    + {hide-from-toc}[Definire il pubblico giusto - NASCOSTO](delivery/using/define-the-right-audience.md)
    + {hide-from-toc}[Controllare prima dell’invio - NASCOSTO](delivery/using/check-before-sending.md)
  + [Inviare e-mail](delivery/using/about-email-channel.md)
  + Inviare e-mail {#sending-emails}
    + {hide-from-toc}[Creare una consegna e-mail - NASCOSTO](delivery/using/creating-an-email-delivery.md)
    + {hide-from-toc}[Definire il contenuto dell’e-mail - NASCOSTO](delivery/using/defining-the-email-content.md)
    + {hide-from-toc}[Definire il contenuto interattivo - NASCOSTO](delivery/using/defining-interactive-content.md)
    + Inviare la consegna e-mail {#sending-an-email}
      + {hide-from-toc}[Passaggi principali per inviare un’e-mail - NASCOSTO](delivery/using/sending-messages.md)
      + {hide-from-toc}[Parametri e-mail - NASCOSTO](delivery/using/email-parameters.md)
      + {hide-from-toc}[Inviare su dispositivi mobili giapponesi - NASCOSTO](delivery/using/sending-emails-on-japanese-mobiles.md)
    + {hide-from-toc}[Allegare i file - NASCOSTO](delivery/using/attaching-files.md)
  + Inviare SMS {#sending-messages-on-mobiles}
    ...
    + {hide-from-toc}[Creare un SMS - NASCOSTO](delivery/using/sms-create.md)
  ...
  + Inviare notifiche push {#sending-push-notifications}
    + {hide-from-toc}[Integrare Campaign SDK nell’applicazione mobile](delivery/using/integrating-campaign-sdk-into-the-mobile-application.md)
    ...
    + Creare una notifica push{#create-a-push-msg}
      + {hide-from-toc}[Creare un messaggio push per iOS - NASCOSTO](delivery/using/create-notifications-ios.md)
      + {hide-from-toc}[Creare un messaggio push per Android - NASCOSTO](delivery/using/create-notifications-android.md)
  ...
  + Inviare direct mail {#sending-direct-mail}
    + {hide-from-toc}[Creare una consegna direct mail - NASCOSTO](delivery/using/creating-a-direct-mail-delivery.md)
    + {hide-from-toc}[Definire il contenuto direct mail - NASCOSTO](delivery/using/defining-the-direct-mail-content.md)
    + {hide-from-toc}[Convalidare - NASCOSTO](delivery/using/validating.md)
  + Utilizzare i modelli di consegna {#using-delivery-templates}
    + {hide-from-toc}[Utilizzare i modelli di consegna - NASCOSTO](delivery/using/about-templates.md)
    + {hide-from-toc}[Creare un modello di consegna - NASCOSTO](delivery/using/creating-a-delivery-template.md)
    + {hide-from-toc}[Selezionare una mappatura target - NASCOSTO](delivery/using/selecting-a-target-mapping.md)
    + {hide-from-toc}[Creare una consegna da un modello - NASCOSTO](delivery/using/creating-a-delivery-from-a-template.md)
  + Personalizzare le consegne {#personalizing-deliveries}
    ...
    + {hide-from-toc}[Campi di personalizzazione - NASCOSTO](delivery/using/personalization-fields.md)
    + {hide-from-toc}[Blocchi di personalizzazione - NASCOSTO](delivery/using/personalization-blocks.md)
    + {hide-from-toc}[Contenuto condizionale - NASCOSTO](delivery/using/conditional-content.md)
    + {hide-from-toc}[Coupon personalizzati - NASCOSTO](delivery/using/personalized-coupons.md)
    + {hide-from-toc}[Generare documenti PDF personalizzati - NASCOSTO](delivery/using/generating-personalized-pdf-documents.md)
...
+ Orchestrare campagne di marketing {#orchestrating-campaigns}
  ...
  + Informazioni sulle campagne di marketing {#about-marketing-campaigns}
    + {hide-from-toc}[Progettare campagne di marketing - NASCOSTO](campaign/using/designing-marketing-campaigns.md)
  ...
  + Orchestrare le campagne {#orchestrate-campaigns}
    ...
    + {hide-from-toc}[Creare e configurare modelli - NASCOSTO](campaign/using/marketing-campaign-templates.md)
    + {hide-from-toc}[Aggiungere consegne - NASCOSTO](campaign/using/marketing-campaign-deliveries.md)
    + {hide-from-toc}[Selezionare il pubblico - NASCOSTO](campaign/using/marketing-campaign-target.md)
    + {hide-from-toc}[Gestire documenti e risorse - NASCOSTO](campaign/using/marketing-campaign-assets.md)
    + {hide-from-toc}[Configurare e gestire le approvazioni - NASCOSTO](campaign/using/marketing-campaign-approval.md)
    + {hide-from-toc}[Monitorare le campagne - NASCOSTO](campaign/using/marketing-campaign-monitoring.md)
    + {hide-from-toc}[Fornitori, scorte e budget - NASCOSTO](campaign/using/providers-stocks-and-budgets.md)
  + Ottimizzazione delle campagne {#campaign-optimization}
    ...
    + {hide-from-toc}[Applicare regole - NASCOSTO](campaign-opt/using/applying-rules.md)
    + {hide-from-toc}[Simulazioni delle campagne - NASCOSTO](campaign-opt/using/campaign-simulations.md)
+ Gestione delle risorse marketing {#mrm}
  + {hide-from-toc}[Informazioni sulla gestione delle risorse marketing - NASCOSTO](mrm/using/about-marketing-resource-management.md)
  + {hide-from-toc}[Creare e gestire le attività - NASCOSTO](mrm/using/creating-and-managing-tasks.md)
  + {hide-from-toc}[Controllare i costi - NASCOSTO](mrm/using/controlling-costs.md)
  + {hide-from-toc}[Gestire le risorse di marketing - NASCOSTO](mrm/using/managing-marketing-resources.md)
  + {hide-from-toc}[Forum di discussione - NASCOSTO](mrm/using/discussion-forums.md)
+ Marketing distribuito {#distributed-marketing}
  ...
  + {hide-from-toc}[Creare una campagna locale - NASCOSTO](distributed/using/creating-a-local-campaign.md)
  + {hide-from-toc}[Creare una campagna collaborativa - NASCOSTO](distributed/using/creating-a-collaborative-campaign.md)
  + {hide-from-toc}[Pubblicare il pacchetto campagna - NASCOSTO](distributed/using/publishing-the-campaign-package.md)
  + {hide-from-toc}[Accedere alle campagne - NASCOSTO](distributed/using/accessing-campaigns.md)
  + {hide-from-toc}[Tracciare una campagna - NASCOSTO](distributed/using/tracking-a-campaign.md)
  + {hide-from-toc}[Casi d’uso - NASCOSTO](distributed/using/examples.md)
...
+ Integrare con Adobe Experience Cloud {#integrating-with-adobe-experience-cloud}
  ...
  + Connettore ACS {#acs-connector}
    ...
    + {hide-from-toc}[Sincronizzare profili - NASCOSTO](integrations/using/synchronizing-profiles.md)
    + {hide-from-toc}[Sincronizzare i tipi di pubblico - NASCOSTO](integrations/using/synchronizing-audiences.md)
    + {hide-from-toc}[Sincronizzare le applicazioni web - NASCOSTO](integrations/using/synchronizing-web-applications.md)
    + {hide-from-toc}[Risolvere i problemi relativi a  [!DNL ACS Connector]  - NASCOSTO](integrations/using/troubleshooting-the-acs-connector.md)
...
+ Automatizzare con i flussi di lavoro {#automating-with-workflows}
  + Introduzione ai flussi di lavoro {#introduction}
    ...
    + {hide-from-toc}[Creare un flusso di lavoro - NASCOSTO](workflow/using/building-a-workflow.md)
    + {hide-from-toc}[Targeting dei dati - NASCOSTO](workflow/using/targeting-data.md)
    + {hide-from-toc}[Utilizzare i dati del flusso di lavoro - NASCOSTO](workflow/using/how-to-use-workflow-data.md)
    + {hide-from-toc}[Best practice per flusso di lavoro - NASCOSTO](workflow/using/workflow-best-practices.md)
  + Eseguire un flusso di lavoro {#executing-a-workflow}
    + {hide-from-toc}[Avviare un flusso di lavoro - NASCOSTO](workflow/using/starting-a-workflow.md)
    + {hide-from-toc}[Ciclo di vita di un flusso di lavoro - NASCOSTO](workflow/using/workflow-life-cycle.md)
    + {hide-from-toc}[Ciclo di vita dei dati - NASCOSTO](workflow/using/data-life-cycle.md)
    + {hide-from-toc}[Definire le approvazioni - NASCOSTO](workflow/using/defining-approvals.md)
    + {hide-from-toc}[Architettura - NASCOSTO](workflow/using/architecture.md)
  + Attività di targeting {#targeting-activities}
    ...
    + {hide-from-toc}[Query - NASCOSTO](workflow/using/query.md)
    + {hide-from-toc}[Query incrementale - NASCOSTO](workflow/using/incremental-query.md)
    + {hide-from-toc}[Leggere un elenco - NASCOSTO](workflow/using/read-list.md)
    ...
    + {hide-from-toc}[Suddivisione - NASCOSTO](workflow/using/split.md)
    + {hide-from-toc}[Celle - NASCOSTO](workflow/using/cells.md)
    + {hide-from-toc}[Offerte per cella - NASCOSTO](workflow/using/offers-by-cell.md)
    + {hide-from-toc}[Struttura della consegna - NASCOSTO](workflow/using/delivery-outline.md)
    + {hide-from-toc}[Arricchimento - NASCOSTO](workflow/using/enrichment.md)
    + {hide-from-toc}[Modificare schema - NASCOSTO](workflow/using/edit-schema.md)
    + {hide-from-toc}[Motore di offerta - NASCOSTO](workflow/using/offer-engine.md)
    + {hide-from-toc}[Deduplica - NASCOSTO](workflow/using/deduplication.md)
    + {hide-from-toc}[Cambiare dimensione - NASCOSTO](workflow/using/change-dimension.md)
    + {hide-from-toc}[Aggiornamento elenco - NASCOSTO](workflow/using/list-update.md)
    + {hide-from-toc}[Servizi di abbonamento - NASCOSTO](workflow/using/subscription-services.md)
    + {hide-from-toc}[Aggiornare dati - NASCOSTO](workflow/using/update-data.md)
    + {hide-from-toc}[Connettore CRM - NASCOSTO](workflow/using/crm-connector.md)
    + {hide-from-toc}[Cambiare origine dati - NASCOSTO](workflow/using/change-data-source.md)
  + Attività di controllo del flusso {#flow-control-activities}
    ...
    + {hide-from-toc}[Attesa - HIDDEN](workflow/using/wait.md)
    ...
    + {hide-from-toc}[Salta (punto iniziale e punto finale) - NASCOSTO](workflow/using/jump-start-point-and-end-point.md)
    ...
    + {hide-from-toc}[Attività - NASCOSTO](workflow/using/task.md)
  + Attività di azione {#action-activities}
    + {hide-from-toc}[Informazioni sulle attività di azione - NASCOSTO](workflow/using/about-action-activities.md)
    + {hide-from-toc}[Consegna - NASCOSTO](workflow/using/delivery.md)
    + {hide-from-toc}[Controllo della consegna - NASCOSTO](workflow/using/delivery-control.md)
    + {hide-from-toc}[Consegna continua - NASCOSTO](workflow/using/continuous-delivery.md)
    + {hide-from-toc}[Consegna ricorrente - NASCOSTO](workflow/using/recurring-delivery.md)
    + {hide-from-toc}[Consegne cross-channel - NASCOSTO](workflow/using/cross-channel-deliveries.md)
    ...
    + {hide-from-toc}[Gestione dei contenuti - NASCOSTO](workflow/using/content-management.md)
    ...
    + {hide-from-toc}[Aggiornare un aggregato - NASCOSTO](workflow/using/update-aggregate.md)
  + Attività dell’evento {#event-activities}
    + {hide-from-toc}[Informazioni sulle attività di eventi - NASCOSTO](workflow/using/about-event-activities.md)
    + {hide-from-toc}[Raccolta file - NASCOSTO](workflow/using/file-collector.md)
  ...
  + Casi d’uso {#use-cases}
    + {hide-from-toc}[Informazioni sui casi d’uso dei flussi di lavoro - NASCOSTO](workflow/using/about-workflow-use-cases.md)
    + Consegne {#deliveries}
      + {hide-from-toc}[Utilizzare l’attività di approvazione locale - NASCOSTO](workflow/using/using-the-local-approval-activity.md)
      + {hide-from-toc}[Inviare un’e-mail di compleanno - NASCOSTO](workflow/using/sending-a-birthday-email.md)
      + {hide-from-toc}[Caricare i contenuti della consegna - NASCOSTO](workflow/using/loading-delivery-content.md)
      + {hide-from-toc}[Flusso di lavoro per consegna cross-channel - NASCOSTO](workflow/using/cross-channel-delivery-workflow.md)
  ...
  + Monitoraggio {#monitoring}
    + {hide-from-toc}[Inviare un rapporto a un elenco - NASCOSTO](workflow/using/sending-a-report-to-a-list.md)
    + {hide-from-toc}[Controllare i flussi di lavoro - NASCOSTO](workflow/using/supervising-workflows.md)
    + {hide-from-toc}[Inviare avvisi personalizzati agli operatori - NASCOSTO](workflow/using/sending-personalized-alerts-to-operators.md)
  + Gestione dati {#data-management}
    + {hide-from-toc}[Coordinare gli aggiornamenti dei dati - NASCOSTO](workflow/using/coordinating-data-updates.md)
    + {hide-from-toc}[Creare un elenco di riepilogo - NASCOSTO](workflow/using/creating-a-summary-list.md)
    + {hide-from-toc}[Arricchire i dati - NASCOSTO](workflow/using/enriching-data.md)
    + {hide-from-toc}[Utilizzare aggregati - NASCOSTO](workflow/using/using-aggregates.md)
    + {hide-from-toc}[Utilizzare la funzionalità di unione dell’attività Deduplica - NASCOSTO](workflow/using/deduplication-merge.md)
    + {hide-from-toc}[Impostare un flusso di lavoro di importazione ricorrente - NASCOSTO](workflow/using/recurring-import-workflow.md)
  + Progettare le query {#designing-queries}
    + {hide-from-toc}[Aggiornamento dell’elenco trimestrale tramite una query incrementale - NASCOSTO](workflow/using/quarterly-list-update.md)
  + Query e filtro {#query-and-filter-hidden}
    ...
    + {hide-from-toc}[Eseguire una query sulle informazioni di consegna - NASCOSTO](workflow/using/querying-delivery-information.md)
    + {hide-from-toc}[Eseguire il calcolo aggregato - NASCOSTO](workflow/using/performing-aggregate-computing.md)
    + {hide-from-toc}[Eseguire una query tramite gestione dei raggruppamenti - NASCOSTO](workflow/using/querying-using-grouping-management.md)
    ...
    + {hide-from-toc}[Aggiungere un campo calcolato di tipo enumerazione - NASCOSTO](workflow/using/adding-enumeration-type-calculated-field.md)
    + {hide-from-toc}[Creare un filtro - NASCOSTO](workflow/using/creating-a-filter.md)
    + {hide-from-toc}[Filtrare i destinatari duplicati - NASCOSTO](workflow/using/filtering-duplicated-recipients.md)
  + Monitorare i flussi di lavoro {#monitoring-workflows}
    + {hide-from-toc}[Monitorare l’esecuzione di un flusso di lavoro - NASCOSTO](workflow/using/monitoring-workflow-execution.md)
    + {hide-from-toc}[Monitorare i flussi di lavoro tecnici - NASCOSTO](workflow/using/monitoring-technical-workflows.md)
    + {hide-from-toc}[HeatMap del flusso di lavoro - NASCOSTO](workflow/using/heatmap.md)
  + Gestione avanzata {#advanced-management}
    + {hide-from-toc}[Proprietà del flusso di lavoro - NASCOST](workflow/using/workflow-properties.md)
    + {hide-from-toc}[Parametri avanzati - NASCOSTO](workflow/using/advanced-parameters.md)
    + {hide-from-toc}[Script e modelli JavaScript - NASCOSTO](workflow/using/javascript-scripts-and-templates.md)
    ...
    + {hide-from-toc}[Gestire le autorizzazioni - NASCOSTO](workflow/using/managing-rights.md)
    + {hide-from-toc}[Modificare le immagini dell’attività - NASCOSTO](workflow/using/managing-activity-images.md)
    + {hide-from-toc}[Gestire i fusi orari - NASCOSTO](workflow/using/managing-time-zones.md)
    + {hide-from-toc}[Flussi di lavoro tecnici - NASCOSTO](workflow/using/about-technical-workflows.md)
...
+ Guida all’installazione e alla configurazione {#installing-campaign-classic}
  ...
  + Appendici {#appendices}
    ...
    + {hide-from-toc}[Disinstallare Campaign](installation/using/uninstalling-campaign.md)
...
+ Guida alla migrazione {#migrating-to-a-new-version}
  + {hide-from-toc}[Introduzione ad Adobe Campaign v7](migration/using/about-migration.md)
  ...
  + {hide-from-toc}[Procedura di rollback](migration/using/about-rollback.md)
+ Note tecniche {#technotes}
  ...
  + Aggiornamenti e compatibilità{#technote-migration}
    ...
    + [Abilitare Microsoft Edge Chromium](technotes/using/edge-chromium.md)
    + {hide-from-toc}[Nuovo server di recapito messaggi](technotes/using/deliverability-server.md)
    + {hide-from-toc}[Aggiornamento di sicurezza Apache](technotes/using/acc-apache-upgrade.md)
    + {hide-from-toc}[Aggiornamenti del sistema 2023](technotes/using/tech-stack-upgrade.md)
    + {hide-from-toc}[Aggiornamenti IMS](technotes/using/ims-updates.md)
    + {hide-from-toc}[Fine del ciclo di vita del supporto per TLS 1.0 e 1.1](technotes/using/eol-tls-support.md)
    + {hide-from-toc}[Eseguire la migrazione all’API di Adobe Analytics 2.0](technotes/using/analytics-2-migration.md)
  + E-mail e notifiche push{#technotes-email}
    ...
    + {hide-from-toc}[Aggiornare i mancati recapiti permanenti errati dopo un’interruzione del servizio ISP](delivery/using/update-bounces.md)
