...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> Grande<br /> </td> 
   <td> Inserimenti, aggiornamenti, eliminazioni<br /> </td> 
   <td> Simile alle altre tabelle del registro di trasmissione, ma con NmsRtEvent anziché NmsRecipient.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> Grande<br /> </td> 
   <td> Inserimenti, aggiornamenti, eliminazioni<br /> </td> 
   <td> Simile a NmsRtEvent. Questa tabella archivia ogni evento da tutte le istanze di esecuzione. Viene utilizzato da nessun processo in tempo reale, solo da report.<br /> </td> 
  </tr> 
  <tr> 
