...
L&#39;esempio seguente può essere utilizzato in un flusso di lavoro per ricompilare le tabelle richieste invece di utilizzare il comando **aspirazione/ricompilazione**:
