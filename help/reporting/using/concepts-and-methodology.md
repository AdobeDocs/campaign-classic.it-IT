...
1. Utilizzo di intervalli di valori definiti manualmente. Ad esempio, età, carrello acquisti medio, numero di consegne aperte, ecc.). Per ulteriori informazioni, consulta [Definizione di ciascun bin](#defining-each-bin).
...
Per creare ogni bin singolarmente, seleziona l’opzione **[!UICONTROL Define each bin]** e utilizza la tabella per creare i vari contenitori.
...
È possibile utilizzare una maschera SQL per combinare più valori in un filtro. A questo scopo, seleziona **[!UICONTROL Yes]** nella colonna **[!UICONTROL Use an SQL mask]** e immetti il filtro SQL da applicare nella colonna **[!UICONTROL Value or expression]**.
...
1. Seleziona l’opzione **[!UICONTROL Dynamically link the values to an enumeration]** e seleziona l’enumerazione corrispondente.
...
Per creare un rapporto utilizzando questa enumerazione, crea un cubo utilizzando la dimensione **[!UICONTROL Email domain]** . Scegli l&#39;opzione **[!UICONTROL Enable binning]** e quindi **[!UICONTROL Dynamically link the values to an enumeration]**. Quindi seleziona l&#39;enumerazione **Domains** come mostrato sopra. Tutti i valori privi di alias specificati verranno raggruppati sotto l&#39;etichetta **Others**.
...
L’enumerazione **[!UICONTROL Domains]** viene utilizzata per generare rapporti incorporati che visualizzano l’elenco dei domini. Per adattare il contenuto di questi rapporti, è possibile modificare questo elenco.
...
1. Fai clic sulla scheda **[!UICONTROL Workflow]** per creare il flusso di lavoro di aggregazione.

   ![](assets/s_advuser_cube_agregate_04.png)

   * L’attività **[!UICONTROL Scheduler]** ti consente di definire la frequenza degli aggiornamenti di calcolo. La pianificazione è dettagliata in [questa sezione](../../workflow/using/scheduler.md).
   * L’attività **[!UICONTROL Aggregate update]** ti consente di selezionare la modalità di aggiornamento da applicare: completo o parziale.
...
Puoi creare tutte le misure necessarie: quindi selezionate la misura da visualizzare o nascondere nella tabella. Per ulteriori informazioni, consulta [Visualizzazione di misure](#displaying-measures).
...
1. Immetti l’etichetta della misura e aggiungi una descrizione, quindi fai clic su **[!UICONTROL Finish]** per crearla.
...
* le informazioni da mostrare/nascondere nel rapporto (consulta [Configurazione della visualizzazione](#configuring-the-display))
* quali misure sono indicate: percentuale, totale, numero di decimali, ecc. (consultare [Modifica del tipo di misura visualizzato](#changing-the-type-of-measure-displayed)).
...
* Fai clic sull&#39;icona **[!UICONTROL Edit the configuration of the pivot table]** per accedere alla finestra di configurazione.
...
A questo scopo, fai clic sull&#39;icona **[!UICONTROL Show the report properties]** e attiva l&#39;opzione **[!UICONTROL Share this report]** .

![](assets/cube_share_option.png)

Specifica la categoria a cui appartiene il rapporto e la sua rilevanza. Per ulteriori informazioni, consulta le sezioni [Questa pagina](../../reporting/using/configuring-access-to-the-report.md#report-display-context) nella sezione **Sequenza di visualizzazione** e **Definizione delle opzioni di filtro** .
...
1. Fai clic sull&#39;icona **[!UICONTROL Add a filter]** .
...
È inoltre possibile creare filtri in base a una selezione. A questo scopo, seleziona le celle, le linee e le colonne di origine, quindi fai clic sull&#39;icona **[!UICONTROL Add a filter]**.
