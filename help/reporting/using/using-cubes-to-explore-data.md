...
* Raccogliere i dati nel database e raggrupparli in elenchi, ad esempio per identificare e generare target e consegne. Per ulteriori informazioni, vedere [Creazione di una popolazione di destinazione](#building-a-target-population).
* Inserire una tabella pivot in un rapporto, fare riferimento a un cubo esistente al suo interno. Per ulteriori informazioni, consultare [Inserimento di una tabella pivot in un report](#inserting-a-pivot-table-into-a-report).
...
## Esplorazione dei dati in un report {#exploring-the-data-in-a-report}

### Passaggio 1 - Creazione di un report basato su un cubo {#step-1---creating-a-report-based-on-a-cube}

Per creare un rapporto basato su un cubo, fare clic sul pulsante **[!UICONTROL Create]** nell&#39;universo **[!UICONTROL Reports]** e selezionare il cubo che si desidera utilizzare.

Il processo è illustrato di seguito: [Creazione di un report basato su un cubo](../../reporting/using/creating-indicators.md#creating-a-report-based-on-a-cube).

### Passaggio 2 - Selezione di righe e colonne {#step-2---selecting-lines-and-columns}
...
1. Selezionate quindi i parametri di questa dimensione.
   ...
   Ad esempio, per le date, possono essere disponibili diversi livelli. Per ulteriori informazioni, vedere [Visualizza misure](../../reporting/using/concepts-and-methodology.md#displaying-measures).
...
1. Fare clic su **[!UICONTROL Ok]** per confermare: la dimensione viene aggiunta alle dimensioni esistenti.
   ...
   Il banner giallo sopra la tabella indica che sono state apportate delle modifiche: fare clic sul pulsante **[!UICONTROL Save]** per salvarli.
...
1. Il pulsante **[!UICONTROL Use a measure]** consente di selezionare una delle misure esistenti.
   ...
   La configurazione globale delle misure è disponibile anche tramite l&#39;icona **[!UICONTROL Edit the configuration of the pivot table]** nell&#39;intestazione.

   ![](assets/s_advuser_cube_in_report_config_02.png)

   È quindi possibile scegliere se visualizzare o meno le etichette delle misure. Per ulteriori informazioni, vedere [Configurazione del display](../../reporting/using/concepts-and-methodology.md#configuring-the-display).

1. È possibile creare nuove misure utilizzando quelle esistenti. A tale scopo, fare clic su **[!UICONTROL Create a measure]** e configurarlo.
   ...
   * Deviazione standard: questo tipo di misura consente di calcolare le deviazioni all&#39;interno di ciascun gruppo di celle rispetto alla media dei valori. Ad esempio, puoi confrontare il volume di acquisto per tutti i segmenti esistenti.
   ...
   Dopo aver creato una misura, potete modificarla e, se necessario, modificarne la configurazione. A questo scopo, fare clic sul pulsante **[!UICONTROL Measures]**, quindi passare alla scheda della misura da modificare.

   Fate clic su **[!UICONTROL Edit the dynamic measure]** per accedere al menu delle impostazioni.

## Creazione di una popolazione di destinazione {#building-a-target-population}
...
1. Fare clic sulle celle contenenti la popolazione da raccogliere per selezionarle, quindi fare clic sull&#39;icona **[!UICONTROL Add to cart]**.

   ![](assets/s_advuser_cube_in_report_config_02c.png)

   Per questo numero di volte necessario per raccogliere i vari profili

1. Fate clic sul pulsante **[!UICONTROL Show cart]** per visualizzarne il contenuto prima di eseguire l&#39;esportazione.

   ![](assets/s_advuser_cube_in_report_config_02d.png)

1. Il pulsante **[!UICONTROL Export]** consente di raggruppare gli elementi nel carrello in un elenco.
...
1. Una volta completata l&#39;esportazione, un messaggio conferma l&#39;esecuzione e il numero di record elaborati.
   ...
   L&#39;elenco pertinente è accessibile tramite l&#39;universo **[!UICONTROL Profiles and targets]**.
...
1. Nella scheda **[!UICONTROL Data]** della pagina, selezionare un cubo per elaborare le dimensioni che contiene e visualizzare le misure calcolate.
