...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> Somma di tutti i @totalClicks con un tipo URL uguale a "Transaction".<br /> </td> 
   <td> sum(Iif([url/@type]=5, @totalClicks, 0))<br /> </td> 
  </tr> 
 </tbody> 
</table>

Questo rapporto è basato sulla tabella **[!UICONTROL Consolidated tracking]** (nms:trackingStats). Questa tabella aggregata viene utilizzata per motivi di prestazioni durante la visualizzazione dei report, al posto della tabella **[!UICONTROL Recipient tracking logs]** (nms:trackingLogRcp) e non viene calcolata in tempo reale. La tabella viene generata alcuni minuti dopo il recupero dei registri di tracciamento. Se gli indicatori sono aggiornati, i risultati saranno gli stessi degli indicatori del rapporto **Indicatori di tracciamento**. L&#39;indicatore @totalclick esprime il numero totale di clic su un periodo di 5 minuti.
...
La seconda parte del rapporto descrive in dettaglio la suddivisione dei messaggi non riusciti per dominio Internet anziché per tipo di errore. La formula collegata all&#39;indicatore **Errore** (@value) in questo caso è: Count(@status=2 e @domain=&quot;Valore del nome di dominio&quot;), ovvero un conteggio di tutti i messaggi con uno stato non riuscito per questo dominio.

## Browser {#browsers-1}

Questo rapporto è basato sulla tabella **[!UICONTROL Internet Browser Statistics]** (nms:userAgentStats).
...
## Condivisione tramite social network {#sharing-to-social-networks-1}
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> Sum(iIf([url/@category]='deliziious',@totalClicks,0))<br /> </td> 
  </tr> 
  <tr> 
   <td> Digg<br /> </td> 
   <td> @digg<br /> </td> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> Suddivisione<br /> </td> 
   <td> @percentuale<br /> </td> 
   <td> Percentuale del numero di azioni sul social network rispetto al numero totale di azioni.<br /> </td> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> @open<br /> </td> 
   <td> Numero totale di linee di tracciamento nella tabella di tracciamento Web.<br /> </td> 
   <td> Count<br /> </td> 
  </tr> 
  <tr> 
   <td> Suddivisione<br /> </td> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> Media giornaliera del numero totale di destinatari mirati dal sistema operativo che hanno fatto clic su una consegna almeno una volta.<br /> </td> 
   <td> Sum(@visitatori)<br /> </td> 
  </tr> 
  <tr> 
...
Questo rapporto è basato sulla tabella **[!UICONTROL Services]** (nms:service).
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> numero totale di sottoscrizioni (azione = 0) nel giorno precedente.<br /> </td> 
  ...
  <tr> 
   <td> Fedeltà<br /> </td> 
   <td> -<br /> </td> 
   <td> Percentuale fedeltà sottoscrittore per il periodo correlato.<br /> </td> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td> Messaggi da distribuire<br /> </td> 
   <td> @toDeliver<br /> </td> 
  ...
  <tr> 
   <td> Fate clic sul collegamento di annullamento sottoscrizione<br /> </td> 
   <td> @optOut<br /> </td> 
   <td> Conteggio di tutti gli @ids con una categoria URL uguale a "Rifiuto".<br /> </td> 
   <td> count(Iif([url/@type]=3, @id, 0))<br /> </td> 
  </tr> 
  <tr> 
   <td> Clicca sul collegamento alla pagina mirror<br /> </td> 
   <td> @mirrorPage<br /> </td> 
  ...
  <tr> 
   ...
   <td> @forward<br /> </td> 
   <td> Differenza tra il numero di persone distinte e il numero di destinatari distinti che hanno fatto clic nel messaggio e-mail almeno una volta.<br /> </td> 
   <td> @PersonClick - @RecipiClick<br /> </td> 
  </tr> 
  <tr> 
   <td> Invia<br /> </td> 
   <td> @successWithoutSeeds<br /> </td> 
   <td> Conteggio dei messaggi per i quali il campo "indirizzo" è uguale a "No" e con uno stato uguale a "preso in considerazione dal destinatario" o "Inviato" o "Ricevuto su dispositivo mobile".<br /> </td> 
   <td> sum([indicatori/@success])<br /> </td> 
  </tr> 
  <tr> 
   <td> Reclami<br /> </td> 
   <td> @reclami<br /> </td> 
   <td> Conteggio dei messaggi con stato uguale a "Non riuscito" e motivo uguale a "indirizzo al elenco Bloccati".<br /> </td> 
   <td> Count(@status=2 e msg/@failureReason=8)<br /> </td> 
  </tr> 
  <tr> 
   <td> Messaggi aperti<br /> </td> 
   <td> @destinatarioOpen<br /> </td> 
   <td> Conteggio di tutti gli @broadLog-ids in tutti i registri di monitoraggio.<br /> </td> 
   <td> Countdistinte ([@broadLog-id])<br /> </td> 
  </tr> 
  <tr> 
   <td> Clic<br /> </td> 
   <td> @destinatarioClick<br /> </td> 
   <td> Conteggio distinto di @broadLog-ids con un tipo URL uguale a "Clic e-mail". <br /> </td> 
   <td> Countdistinte(Iif([url/@type]=1, @broadLog-id, 0))<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> Conteggio di tutti gli @source-ids con una categoria URL uguale a "Email click".<br /> </td> 
   <td> Countdistinte(Iif([url/@type]=1, @source-id, 0))<br /> </td> 
  </tr> 
  <tr> 
   <td> Clic cumulati<br /> </td> 
   <td> @totalRecipientClick<br /> </td> 
   <td> Conteggio di tutti gli @ids con una categoria URL che corrisponde a "Email click".<br /> </td> 
   <td> count(Iif([url/@type]=1, @id, 0))<br /> </td> 
  </tr> 
  <tr> 
   <td> Clic del destinatario<br /> </td> 
   <td> @destinatarioClick<br /> </td> 
   <td> Conteggio distinto degli @wideLog-ids con un tipo di URL che corrisponde a "Email click".<br /> </td> 
   <td> Countdistinte(Iif([url/@type]=1, @broadLog-id, 0))<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td> Items<br /> </td> 
   <td> @article<br /> </td> 
   <td> Somma di articoli webTrackingLog/@con un tipo di URL uguale a "Transaction".<br /> </td> 
  ...
  <tr> 
   <td> Twitter<br /> </td> 
   <td> @twitter<br /> </td> 
   <td> Somma di tutti i @totalClicks con una categoria di URL uguale a "twitter".<br /> </td> 
   <td> Sum(iIf([url/@category]='twitter',@totalClicks,0))<br /> </td> 
  </tr> 
  <tr> 
   <td> Delicious<br /> </td> 
   <td> @delizioso<br /> </td> 
   <td> Somma di tutti i @totalClicks con una categoria di URL uguale a "delizioso".<br /> </td> 
   <td> Sum(iIf([url/@category]='deliziious',@totalClicks,0))<br /> </td> 
  </tr> 
  <tr> 
   <td> Digg<br /> </td> 
   <td> @digg<br /> </td> 
   <td> Somma di tutti i @totalClicks con una categoria URL uguale a "digg".<br /> </td> 
   <td> Sum(iIf([url/@category]='digg',@totalClicks,0))<br /> </td> 
  </tr> 
  <tr> 
   <td> Google<br /> </td> 
  ...
  <tr> 
   <td> Linkedin<br /> </td> 
   <td> @linkedin<br /> </td> 
   <td> Somma di tutti i @totalClicks con una categoria URL uguale a "linkedin".<br /> </td> 
   <td> Sum(iIf([url/@category]='linkedin',@totalClicks,0))<br /> </td> 
  </tr> 
 </tbody> 
</table>
...
Questo rapporto è basato sulla tabella **[!UICONTROL Delivery]** (nms:delivery).
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td> Reattività<br /> </td> 
   <td> @reactivity<br /> </td> 
   <td> Rapporto tra il numero di destinatari a cui è stato fatto clic in una consegna almeno una volta rispetto al numero stimato di destinatari a cui è stata aperta una consegna almeno una volta.<br /> </td> 
  ...
  <tr> 
   ...
   <td> percentuale([indicatori/@personaClic], [indicatori/@success])<br /> </td> 
  </tr> 
  <tr> 
   <td> Clic cumulati<br /> </td> 
  ...
  <tr> 
   <td> Clic<br /> </td> 
   <td> @_click<br /> </td> 
   <td> Conteggio di tutti i @totalClicks con una chiave primaria URL diversa da 1<br /> </td> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> @totalTarget<br /> </td> 
   <td> Numero totale di destinatari per la consegna.<br /> </td> 
   <td> sum([properties/@totalTarget])<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> Numero di indirizzi in quarantena dopo un errore di consegna (dominio sconosciuto dell'utente e non valido).<br /> </td> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> Clic<br /> </td> 
   <td> @click<br /> </td> 
   <td> Somma di tutti i @totalClicks con un tipo di URL che corrisponde a "Email click".<br /> </td> 
   <td> sum(Iif([url/@type] = 1, @totalClicks, 0))<br /> </td> 
  </tr> 
  <tr> 
   <td> Open<br /> </td> 
   <td> @open<br /> </td> 
   <td> Somma di tutti i @totalClicks con una chiave primaria URL uguale a 1.<br /> </td> 
   <td> sum(Iif([@url-id] = 1, @totalClicks, 0))<br /> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> @softBounce<br /> </td> 
   <td> Totale di tutti i messaggi con uno stato uguale a "Operazione non riuscita" e un motivo uguale a "Impossibile raggiungere", "Posta in arrivo completa", "Dominio non valido", "Account disabilitato", "Non connesso" o "Rifiutato"<br /> </td> 
...
Questo rapporto si basa sulle tabelle **Consegne** (nms:delivery) e **Registri di monitoraggio** (nms:trackingLogRcp).
...
Se si verificano desincronizzazione o incoerenza per alcuni indicatori, selezionare la consegna interessata nell&#39; Adobe Campaign Explorer, fare clic con il pulsante destro del mouse e scegliere **[!UICONTROL Action>Recompute delivery and tracking indicators]**. Fare clic su **[!UICONTROL Next]**, quindi su **[!UICONTROL Finish]**.
