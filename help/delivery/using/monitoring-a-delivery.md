...
La **[!UICONTROL Tracking]** scheda elenca la cronologia di tracciamento per la consegna. In questa scheda vengono visualizzati i dati di tracciamento dei messaggi inviati, ovvero tutti gli URL soggetti al tracciamento da parte di Adobe Campaign. I dati di tracciamento vengono aggiornati ogni ora.
...
* Alcuni provider di posta elettronica potrebbero avere inserito in blacklist i tuoi indirizzi IP. In questo caso, controlla i tuoi blog e consulta [questa guida introduttiva](https://docs.campaign.adobe.com/doc/AC/getting_started/EN/deliverability.html) .
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> Ignorato<br /> </td> 
   <td> La consegna non è stata inviata al destinatario a causa di un errore con il suo indirizzo. È stato inserito in blacklist, in quarantena, non fornito o duplicato. <br /> </td> 
  </tr> 
  <tr> 
   <td> Inviato<br /> </td> 
...
Per informazioni su come ottimizzare la recapito dei messaggi e-mail di Adobe Campaign, consulta la Guida [alle procedure ottimali per la](https://docs.campaign.adobe.com/doc/AC/getting_started/EN/deliverability.html) distribuzione di Adobe Campaign e [questa pagina](../../delivery/using/about-deliverability.md).
