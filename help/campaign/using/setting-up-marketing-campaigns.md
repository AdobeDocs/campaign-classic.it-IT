...
1. Creare una campagna: scopri le campagne e le loro caratteristiche: etichetta, tipo, date di inizio e fine, budget, risorse associate, manager e partecipanti.
   ...
   Vedere [Creazione di una campagna](#creating-a-campaign).

1. Definire le popolazioni target: creare un flusso di lavoro con query di targeting.

   Vedere [Selezione della popolazione di destinazione](../../campaign/using/marketing-campaign-deliveries.md#selecting-the-target-population).

1. Crea consegne: selezionare i canali e definire il contenuto da inviare.

   Vedere [Creazione di consegne](../../campaign/using/marketing-campaign-deliveries.md#creating-deliveries).

1. Approvare le consegne.

   Fare riferimento a [Processo di approvazione](../../campaign/using/marketing-campaign-approval.md#approval-process).

1. Monitorare le consegne.

   Fare riferimento a [Monitoring](../../campaign/using/marketing-campaign-monitoring.md).

1. Pianificare campagne e costi associati.

   Vedere [Creazione di provider di servizi e relative strutture di costo](../../campaign/using/providers--stocks-and-budgets.md#creating-service-providers-and-their-cost-structures).

Una volta completati questi passaggi, è possibile avviare le consegne (vedere [Avvio di una consegna](../../campaign/using/marketing-campaign-deliveries.md#starting-a-delivery)), controllare i dati, i processi e le informazioni relativi alle consegne e, se necessario, gestire i documenti associati (vedere [Gestione dei documenti associati](../../campaign/using/marketing-campaign-deliveries.md#managing-associated-documents)). È inoltre possibile monitorare l&#39;esecuzione delle fasi di elaborazione delle campagne e delle consegne (vedere [Tracking](../../campaign/using/marketing-campaign-monitoring.md)).
...
1. Fare clic sull&#39;icona **Esplora risorse** nella pagina principale.
1. Fare clic con il pulsante destro del mouse sulla cartella in cui si desidera creare il piano.
1. Selezionare **Aggiungi nuova cartella > Gestione campagna > Piano**.
...
1. Nella scheda **Generale**, modificare il **Nome interno** per evitare duplicati durante le esportazioni dei pacchetti.
1. Fai clic su **Salva**.
1. Fare clic con il pulsante destro del mouse sul piano appena creato e selezionare **Crea una nuova cartella &#39;Program&#39;**.
...
Potete creare una campagna tramite l&#39;elenco delle campagne. Per visualizzare questa visualizzazione, selezionare il menu **[!UICONTROL Campaigns]** nel dashboard di **[!UICONTROL Campaigns]**.

![](assets/s_ncs_user_add_an_op_from_list.png)

Il campo **[!UICONTROL Program]** consente di selezionare il programma al quale verrà associata la campagna. Queste informazioni sono obbligatorie.

![](assets/s_ncs_user_new_op_wz_a.png)

Le campagne possono essere create anche tramite un programma. A tal fine, fare clic sul pulsante **[!UICONTROL Add]** nella scheda **[!UICONTROL Schedule]** del programma interessato.

![](assets/s_ncs_user_add_an_op.png)

Quando create una campagna tramite la scheda **[!UICONTROL Schedule]** di un programma, la campagna viene automaticamente collegata al programma interessato. Il campo **[!UICONTROL Program]** è nascosto in questo caso.
...
Fate clic su **[!UICONTROL OK]** per creare la campagna. Viene aggiunto al programma.

![](assets/s_ncs_user_program_planning_with_op.png)

>[!NOTE]
>
>Per filtrare le campagne da visualizzare, fate clic sul collegamento **[!UICONTROL Filter]** e selezionate lo stato delle campagne da visualizzare.
...
1. Create un modello di campagna **[!UICONTROL Recurring]**.
...
1. Per questo tipo di campagna, viene aggiunta una scheda **[!UICONTROL Schedule]** per creare il programma di esecuzione del modello.

In questa scheda, specificate le date di esecuzione pianificate delle campagne in base a questo modello.

![](assets/s_ncs_user_op_template_recur_planning.png)

La modalità di configurazione del programma di esecuzione coincide con l&#39;oggetto **[!UICONTROL Scheduler]** del flusso di lavoro. Per ulteriori informazioni al riguardo, consulta [questa sezione](../../workflow/using/architecture.md).
...
1. Specificate un valore nel campo **[!UICONTROL Create in advance for]** per creare i flussi di lavoro corrispondenti per il periodo indicato.
1. Create il modello di workflow da utilizzare nelle campagne basate su questo modello, con i parametri di targeting e uno o più invii generici.
   ...
   >[!NOTE]
   >
   >Questo flusso di lavoro deve essere salvato come modello di flusso di lavoro periodico. A questo scopo, modificate le proprietà del flusso di lavoro e selezionate l&#39;opzione **[!UICONTROL Recurring workflow template]** nella scheda **[!UICONTROL Execution]**.
...
1. La pianificazione della campagna consente di inserire una data di inizio di creazione o esecuzione automatica del flusso di lavoro per ogni riga.
   ...
   * **[!UICONTROL To be started]** : consente di avviare il flusso di lavoro una volta raggiunta la data di inizio.
   ...
   Il campo **[!UICONTROL Create in advance for]** consente di creare tutti i flussi di lavoro che coprono il periodo immesso.

   Dopo l&#39;esecuzione del flusso di lavoro **[!UICONTROL Jobs on campaigns]**, i flussi di lavoro dedicati vengono creati in base alle occorrenze definite nella pianificazione della campagna. Viene quindi creato un flusso di lavoro per ogni data di esecuzione.

1. I flussi di lavoro periodici vengono creati automaticamente dal modello di flusso di lavoro presente nella campagna. Sono visibili dalla scheda **[!UICONTROL Targeting and workflows]** della campagna.
...
#### Creazione del modello di campagna {#creating-the-campaign-template-1}

1. Create un modello di campagna **[!UICONTROL Periodic]**, preferibilmente duplicando un modello di campagna esistente.
...
1. Completare il programma di esecuzione come per un modello di campagna ricorrente: fare clic sul pulsante **[!UICONTROL Add]** e definire le date di inizio e di fine, oppure compilare il programma di esecuzione tramite il collegamento.
