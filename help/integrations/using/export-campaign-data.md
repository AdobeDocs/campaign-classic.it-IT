...
Per esportare i dati di Campaign Classic in Adobe Real-time Customer Data Platform (RTCDP), devi innanzitutto creare un flusso di lavoro in Campaign Classic per esportare nel percorso di archiviazione BLOB S3 o Azure i dati che desideri condividere.
...
Per esportare i dati da Campaign Classic al percorso di archiviazione S3 o Azure Blob, devi creare un flusso di lavoro per eseguire il targeting dei dati da esportare e inviarli al percorso di archiviazione.
