...
1. Connetti Adobe Experience Manager ad Adobe Campaign configurando un **Cloud Service** dedicato.
   ...
   Per informazioni su come connettere entrambe le soluzioni tramite Cloud Services, consulta la [documentazione](https://helpx.adobe.com/it/experience-manager/6-5/sites/administering/using/campaignonpremise.html#ConfiguringAdobeExperienceManager) di Adobe Experience Manager.
