---
title: Connettore CRM
description: Ulteriori informazioni sul connettore CRM e configurare la sincronizzazione dei dati con Adobe Campaign.
...
La **[!UICONTROL Behavior]** scheda consente di abilitare l&#39;elaborazione dei rifiuti. Questa opzione genera una seconda transizione di output per l&#39; **[!UICONTROL CRM connector]** attività. For more on this, refer to this [section](../../platform/using/crm-connectors.md#error-processing).
