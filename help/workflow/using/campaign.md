...
I flussi di lavoro descritti di seguito vengono installati con il modulo **Campaign** per impostazione predefinita. Per ulteriori informazioni su questo modulo, consulta questa [sezione](../../campaign/using/designing-marketing-campaigns.md).
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td> <span class="uicontrol">Calcolo</span> dei costi <br /> </td> 
  ...
  <tr> 
   <td> <span class="uicontrol">Processi</span> campagna <br /> </td> 
  ...
  <tr> 
   <td> <span class="uicontrol">Processi dei fornitori</span> di servizi <br /> </td> 
