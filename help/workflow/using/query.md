...
1. Se hai selezionato **[!UICONTROL Filtering conditions]** al passaggio 1 o utilizzando **[!UICONTROL Filters]** > **[!UICONTROL Advanced filter...]** , sarà necessario aggiungere manualmente i criteri di filtro in un secondo momento.
   ...
   È inoltre possibile aggiungere altri criteri utilizzando il generatore di espressioni e combinarlo con le opzioni logiche AND, OR e EXCEPT. Puoi quindi visualizzare in anteprima **[!UICONTROL Corresponding SQL query...]** per la combinazione di criteri. Per ulteriori informazioni, consulta questa pagina [sezione](../../platform/using/defining-filter-conditions.md#building-expressions).
...
1. Specifica la sottoselezione della raccolta. Ad esempio: acquisti effettuati solo negli ultimi 15 giorni.
...
Per ulteriori informazioni sul filtraggio delle dimensioni, consulta [questa sezione](building-a-workflow.md#targeting-and-filtering-dimensions).
