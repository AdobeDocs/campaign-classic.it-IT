...
>[!NOTE]
>
>Se non vengono visualizzati dati nel Workflow HeatMap, fare clic sul pulsante **[!UICONTROL Load data]** .
...
1. Puoi anche scegliere un flusso di lavoro specifico dall’elenco a discesa **[!UICONTROL Workflows]** .
