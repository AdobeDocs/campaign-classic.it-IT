...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Questo flusso di lavoro è il flusso di lavoro di manutenzione del database: effettua diversi calcoli dalle statistiche e dai processi ed elimina i dati obsoleti dal database in base alla configurazione definita nell'Assistente distribuzione. Viene attivato ogni giorno alle 4 del mattino per impostazione predefinita.</p> <p>Per ulteriori informazioni, consultare questa <a href="../../production/using/database-cleanup-workflow.md">pagina</a>.</p> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">Pulizia</span> dei flussi di lavoro in pausa <br /> </td> 
  ...
  <tr> 
   <td> <span class="uicontrol">Notifica</span> offerta <br /> </td> 
