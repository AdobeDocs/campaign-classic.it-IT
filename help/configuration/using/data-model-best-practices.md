...
>
>Se i vecchi dati non sono stati eliminati, il risultato sarà una violazione chiave univoca, che diventa un blocco per lo stato e l&#39;utilizzo della piattaforma. Adobe Campaign non sarebbe in grado di inviare comunicazioni (quando ha un impatto sulla tabella di registro di consegna) e le prestazioni sarebbero fortemente influenzate.
