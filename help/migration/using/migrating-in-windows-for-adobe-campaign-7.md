...
1. Arresta servizi: fare riferimento a [Arresto del servizio](#service-stop).
...
1. Elimina e pulisci la versione precedente  Adobe Campaign: fare riferimento a [Eliminazione e pulizia  versione precedente di Adobe Campaign](#deleting-and-cleansing-adobe-campaign-previous-version).
...
1. Il modulo **mta** e i relativi moduli secondari (**mtachild**) devono essere interrotti utilizzando i comandi seguenti:
...
1. Modificate la **config-`<instance name>`.xml** (in **Neolane v5). back** cartella) per impedire che **mta**, **wfserver**, **stat** ecc. l&#39;avvio automatico dei servizi. Ad esempio, sostituire **autoStart** con **_autoStart**.
...
1. Modificate la **config-`<instance name>`.xml** (in **Neolane v6. back** cartella) per impedire che **mta**, **wfserver**, **stat** ecc. l&#39;avvio automatico dei servizi. Ad esempio, sostituire **autoStart** con **_autoStart**.
...
1. Eseguire un backup del database Adobe Campaign .
1. Eseguire un backup della directory **Adobe Campaign v6** utilizzando il seguente comando:
...
1. Per rendere disponibile il programma di installazione della console client, copiate il file **setup-client-7.0.XXXX.exe** nella directory di installazione  Adobe Campaign: **C:\Program Files\Adobe\Adobe Campaign v7\datakit\nl\eng\jsp**.
...
1. Modificare i binding (porte di ascolto) del sito utilizzato per  versione precedente di Adobe Campaign:
   ...
   * Fare clic con il pulsante destro del mouse sul sito utilizzato per  versione precedente di Adobe Campaign e selezionare **[!UICONTROL Edit bindings]**.
   * Per ciascun tipo di porta di ascolto (**[!UICONTROL http]** e/o **[!UICONTROL https]**), selezionare la riga appropriata e fare clic su **[!UICONTROL Edit]**.
...
1. Create un nuovo sito Web per  Adobe Campaign v7:
   ...
   * Il percorso di accesso alla directory di base del sito Web non viene utilizzato, ma è necessario immettere il campo **[!UICONTROL Physical access path]**. Immettere il percorso di accesso predefinito di IIS: **C:\inetpub\wwwroot**.
   * Fare clic sul pulsante **[!UICONTROL Connect as...]** come e assicurarsi che l&#39;opzione **[!UICONTROL Application user]** sia selezionata.
   * È possibile lasciare i valori predefiniti nei campi **[!UICONTROL IP address]** e **[!UICONTROL Port]**. Se desiderate utilizzare altri valori, accertatevi che l&#39;indirizzo IP e/o la porta siano disponibili.
   * Selezionare la casella **[!UICONTROL Start Web site immediately]**.

      ![](assets/_migration_iis_5_7.png)

1. Eseguire lo script **iis_neolane_setup.vbs** per configurare automaticamente le risorse utilizzate dal server Adobe Campaign  nella directory virtuale precedentemente creata.
   ...
   * Nella scheda **[!UICONTROL Content view]**, accertatevi che la configurazione del sito Web sia configurata correttamente con  risorse Adobe Campaign:
...
1. Rinominare la cartella **Neolane v5.back** come **Neolane v5**.
...
1. Rinominare la cartella **Neolane v6.back** come **Neolane v6**.
...
1. Rinominare la cartella **Adobe Campaign v6.back** come **Adobe Campaign v6**.
