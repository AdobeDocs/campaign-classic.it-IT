...
1. [Passaggio 4: creare il contenuto](#step-4---creating-the-page-content) della pagina,
1. [Passaggio 5: memorizzare i dati](#step-5---storing-the-survey-data-) del sondaggio,
1. [Passaggio 6: pubblicare le pagine](#step-6---publishing-the-pages),
1. [Passaggio 7: condividi il sondaggio](#step-7---sharing-your-online-survey) online.
...
Puoi quindi monitorare le risposte degli utenti tramite report e registri. Consulta [Tracciamento delle risposte](../../surveys/using/publish--track-and-use-collected-data.md#response-tracking).
