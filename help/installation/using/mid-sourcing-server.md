---
title: Installazione di un server di mid-sourcing in Adobe Campaign Classic
description: Questa sezione descrive l'installazione e la configurazione di un server di mid-sourcing in Adobe Campaign Classic.
...
### Installazione e configurazione del server applicazione per la distribuzione mid-sourcing {#installing-and-configuring-the-application-server-for-mid-sourcing-deployment}
...
1. Crea una cartella nel **[!UICONTROL Mid-sourcing > Deliveries]** nodo che verrà associata all&#39;account mid-sourcing predefinito (ad esempio: prod).
1. Create una cartella nel **[!UICONTROL Mid-sourcing > Deliveries]** nodo con lo stesso nome dell’account (ad esempio: accept_test).
...
1. Nella **[!UICONTROL Access rights]** scheda, assegnate a questo operatore i diritti del gruppo di **invio** mid-sourcing. Questo diritto di accesso è disponibile in **[!UICONTROL Mid-sourcing > Access Management > Operator groups]**.

   ![](assets/mid_recette_user_rights.png)

1. Selezionate l&#39; **[!UICONTROL Restrict to data in the sub-folders of]** opzione e selezionate la cartella consegne per limitare l&#39;operatore alla cartella consegne di origine intermedia.
...
## Configurazione del tracciamento su un server mid-sourcing {#configuring-tracking-on-a-mid-sourcing-server}
...
1. Dopo aver inserito i parametri di connessione, fate clic su **[!UICONTROL Confirm the configuration]**.
1. Se necessario, specificate la posizione in cui memorizzare le immagini contenute nelle consegne. A questo scopo, selezionare una delle modalità di pubblicazione dall&#39;elenco a discesa.
   ...
   Se scegliete l’ **[!UICONTROL Tracking server(s)]** opzione, le immagini verranno copiate sul server di mid-sourcing.

**Configurazione della piattaforma cliente**

1. Passare al conto di routing mid-sourcing esterno.
1. Nella **[!UICONTROL Mid-Sourcing]** scheda, specificare i parametri di connessione del server di origine mid-sourcing.
