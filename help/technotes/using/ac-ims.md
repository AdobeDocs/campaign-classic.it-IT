...
Si consiglia di eseguire la migrazione a [Adobe Identity Management System (IMS)](https://helpx.adobe.com/it/enterprise/using/identity.html){target="_blank"} per aggiornare l&#39;ambiente a Campaign Classic v7.4.1 (o a una versione [compatibile con la migrazione IMS](#ims-versions)).
...
Dopo aver aggiornato gli ambienti a Campaign Classic v7.4.1 (o a una versione [compatibile con la migrazione IMS](#ims-versions)), puoi avviare la transizione a [Adobe Identity Management System (IMS)](https://helpx.adobe.com/it/enterprise/using/identity.html){target="_blank"}.
