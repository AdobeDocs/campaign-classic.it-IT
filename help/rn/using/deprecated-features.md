...
<table> 
 <tbody> 
  ...
  <td>CentOs 8.x (64 bit)<br></td>
   <td><p>CentOS Linux 8 raggiungerà la fine del ciclo di vita (EOL) il 31 dicembre 2021. <a href="https://www.centos.org/centos-linux-eol/">Ulteriori informazioni</a></p>
   <p>Se utilizzi questo sistema operativo, devi adattare di conseguenza l’implementazione. CentOS 7.x (64 bit) e RHEL 8.x/7.x (64 bit) sono ancora supportati.</p>
  <p><em>Data di rimozione prevista: 31 dicembre 2021.</em></p>
  </td>
 </tr>
    <tr>
  ...
  <p><em>Data di rimozione target: 17 agosto 2022</em></p>
  </td>
 </tr>
    <tr>
  ...
  <p><em>Data di rimozione target: Inizio 2022</em></p>
  </td>
 </tr>
  <tr>
  ...
  <p><em>Data di rimozione target: 20 ottobre 2021. Gli ambienti in hosting beneficiano di un’estensione fino al 23 febbraio 2022. </em></p>
  </td>
  </tr>
 </tbody> 
</table>
...
<table> 
 ...
 <tr>  
   <td>Connettori di gestione delle relazioni con i clienti attività<br></td>
   <td><p> Le attività di azione Microsoft CRM, Salesforce, Oracle CRM On Demand non sono più disponibili.</p>
   <p>Per configurare la sincronizzazione dati tra Adobe Campaign e un sistema CRM, puoi utilizzare l’attività del connettore CRM.</p>
   <p><a href="../../workflow/using/crm-connector.md">Ulteriori informazioni</a></p>
  </tr>
  <tr>  
...
A partire dalla versione 21.1.3, il supporto per Debian 8 è diventato obsoleto.
