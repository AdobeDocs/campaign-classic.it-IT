...
<table> 
 <tbody>
  ...
  <tr>  
   <td>Canale fax<br></td>
   <td><p>A partire dalla versione Campaign 21.1.3, il canale fax non è più disponibile. <a href="https://experienceleague.adobe.com/docs/campaign/campaign-v8/send/create-message.html?lang=it" target="_blank">Ulteriori informazioni sono disponibili nella documentazione di Campaign v8</a></p>
  </tr>
  <tr>
