...
description: Note sulla versione di Campaign Classic 19.2
...
A partire da Campaign Classic 19.2, a ciascuna build viene associato uno stato. Di seguito sono elencati gli stati, il loro significato e l’immagine associata:

![](assets/green2.png)**Disponibilità** generale: ultima build stabile disponibile.

![](assets/blue2.png)**Candidato** alla versione: convalidato da Adobe, in attesa di prove di produzione.

![](assets/orange2.png)**** Non più disponibile: build più recente disponibile, è necessario aggiornare.

![](assets/green3.png)**Disponibilità** generale: ultima build stabile disponibile.

![](assets/blue3.png)**Candidato** alla versione: convalidato da Adobe, in attesa di prove di produzione.

![](assets/orange3.png)**** Non più disponibile: build più recente disponibile, è necessario aggiornare.

<table> 
 <tbody> 
  <tr> 
   <td><img src="assets/green.png"/></td>
   <td>Disponibilità generale</td>
   <td>Ultima build stabile disponibile.</td>
  </tr> 
   <tr> 
   <td><img src="assets/blue.png"/></td> 
   <td>Release Candidate</td>
   <td>Questa build è stata convalidata da Adobe.  In attesa di prove di produzione.</td>
  </tr> 
  <tr> 
   <td><img src="assets/orange.png"/></td> 
   <td>Non più disponibile</td>
   <td>Questa build non presenta problemi importanti, ma è disponibile una nuova build con correzioni di bug aggiuntive. L'aggiornamento è obbligatorio.</td>
  </tr> 
 </tbody> 
</table>
...
<tr>
  <td>
    ...
    <div>
    <img src="assets/green3.png"/><strong>Disponibilità generale</strong>
    </div>
    <p>
    <em>Ultima build stabile disponibile.</em>
    <p>
  </td>
  <td>
    ...
    <p>
    <em>Questa build è stata convalidata da Adobe. In attesa di prove di produzione.</em>
    <p>
  </td>
   <td>
    <img src="assets/update.png" />
    <div>
    <img src="assets/orange3.png"/><strong>Non più disponibile</strong>
    </div>
    <p>
    <em>Questa build non presenta problemi importanti, ma è disponibile una nuova build con correzioni di bug aggiuntive. L'aggiornamento è obbligatorio.</em>
    <p>
  </td>
</tr>
</table>
...
| Risorse aggiuntive: |  |
|--- |--- |
| [Aggiornamento alla build più recente](https://helpx.adobe.com/campaign/kb/acc-build-upgrade.html) | [Note sulla versione del Pannello di controllo](https://docs.adobe.com/content/help/en/control-panel/using/release-notes.html) |
| [Ultimi aggiornamenti della documentazione](../../rn/using/documentation-updates.md) | [Note sulla versione precedente](../../rn/using/release--19-1.md) |
...
<table> 
 <thead> 
  <tr> 
   <th> Monitoraggio live del flusso di lavoro<br /> </th> 
  </tr> 
 </thead> 
 <tbody> 
  <tr> 
...
<table> 
 <thead> 
  <tr> 
   <th> Contenuto interattivo con AMP<br /> </th> 
  </tr> 
 </thead> 
 <tbody> 
  <tr> 
