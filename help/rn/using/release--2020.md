...
* Sono state migliorate le regole di convalida degli indirizzi e-mail per mettere un indirizzo in quarantena in caso di errore morbido. [Ulteriori informazioni](../../delivery/using/understanding-quarantine-management.md#soft-error-management)
