...
The following systems are now [deprecated](https://helpx.adobe.com/it/campaign/kb/deprecated-and-removed-features.html) for Campaign Classic implementations:
* Apache 2.2
* Centos 6
