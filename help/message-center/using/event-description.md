...
Per ulteriori informazioni sulla generazione di un file WSDL, consulta [questa sezione](../../configuration/using/web-service-calls.md#web-service-description--wsdl).
