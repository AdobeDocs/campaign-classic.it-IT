...
---
# PROMPT 2: Analizzare la cartella Détaillée d&#39;un
...
1. **Copia l&#39;intero prompt sopra**
2. **Sostituisci percorso cartella**:
...
4. **Esegui analisi**
5. **Ottieni report completo Markdown**
6. **Salva con nome**: `[folder]-detailed-analysis.md`
...
Prova con:
- `/help/delivery/using/` (111 file)
- `/help/workflow/using/` (121 file)
- `/help/platform/using/` (61 file)
- `/help/web/using/` (26 file)

---

## ANTEPRIMA DI OUTPUT

Il rapporto sarà di circa 30-40 pagine di Markdown dettagliato con:
- Statistiche di riepilogo
- Tabella completa con tutti i file
- Fino a 3 corrispondenze v8 per file
- Percentuali di corrispondenza
- Ricapitolazioni dettagliate dei file
- Piano di riorganizzazione
- Elementi azione

Perfetto per l&#39;esecuzione! ✅
